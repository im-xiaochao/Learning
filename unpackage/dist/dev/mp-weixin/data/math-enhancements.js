...
function getMathEnhancement(title) {
  const hit = ENHANCEMENTS.find(([keyword]) => title.includes(keyword));
  return (hit == null ? void 0 : hit[1]) ?? null;
}
function hasMathContent(point) {
  return point.blocks.some((block) => block.lines.length > 0);
}
exports.getMathEnhancement = getMathEnhancement;
exports.hasMathContent = hasMathContent;
//# sourceMappingURL=../../.sourcemap/mp-weixin/data/math-enhancements.js.map
