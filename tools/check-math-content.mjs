...
const GOLDEN = [
  ...
  ['一元函数微分学', '复合函数求导', '链式法则', '要的是链式法则，不是复合函数的定义'],
  ...
  // 高数第 2 章「一元函数微分学」（数一/数二 两册）
  ['一元函数微分学', '导数定义', '差商', '导数是差商的极限'],
  ['一元函数微分学', '拉格朗日中值定理', 'f′(ξ)', '中值定理的结论式'],
  ['一元函数微分学', '皮亚诺余项', 'o((x−x₀)ⁿ)', '皮亚诺余项是定性的'],
  ['一元函数微分学', '拉格朗日余项', 'f⁽ⁿ⁺¹⁾(ξ)', '拉格朗日余项是定量的'],
  ['一元函数微分学', '曲率半径', 'ρ=1/κ', '曲率半径是曲率的倒数'],
  ['一元函数微分学', '使用条件', '三条', '洛必达的三条前提'],
]
...
function curatedKeys() {
  ...
  // 键有三种写法：双引号（标题里含单引号时用，如 "dy=f'(x)dx"）、单引号、裸标识符
